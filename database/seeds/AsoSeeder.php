...
class AsoSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $item->value = 'http://haxibiao-1251052432.cos.ap-guangzhou.myqcloud.com/haxibiao-release.apk';
        $item->save();
        ...
        $item->value = '/images/app/haxibiao1.png';
        $item->save();
        ...
        $item->value = '/images/app/haxibiao2.png';
        $item->save();
        $item = Aso::firstOrCreate([
            'group' => '下载页',
            'name'  => '功能介绍2标题',
        ...
        $item->value = '/images/app/haxibiao3.png';
        $item->save();
        $item = Aso::firstOrCreate([
            'group' => '下载页',
            'name'  => '功能介绍3标题',
        ...
        $item->value = '/images/app/haxibiao4.png';
        $item->save();
        $item = Aso::firstOrCreate([
            'group' => '下载页',
            'name'  => '功能介绍4标题',
